        ...
        Contact us
            ...
            <section className="py-20 text-center relative z-10">
              <div className="container mx-auto px-4">
                ...
                <p className="text-lg max-w-3xl mx-auto">Traditional education often overlooks individual emotional and
                  cognitive needs, leading to disengagement and less effective learning experiences.</p>
              </div>
            </section>
            ...
            <section className="py-20 text-center relative z-10">
              <div className="container mx-auto px-4">
                ...
                <p className="text-lg max-w-3xl mx-auto mb-4">Adaptive Intelligence uses real-time emotion recognition
                  to tailor educational content to how you feel at any given moment.</p>
                <p className="text-lg max-w-3xl mx-auto">By integrating advanced AI technologies like emotion analysis
                  from Hume AI, we create a learning environment that responds uniquely to each student.</p>
              </div>
            </section>
          </main>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-400">Doctoral Candidate, Junia Graduate School of Science and
                  Engineering</p>
