      ...
      <main>
        ...
        <section className="py-12 bg-gray-900">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg">Traditional education often overlooks individual emotional and cognitive needs, leading to disengagement and less effective learning experiences.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-gray-800">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg mb-4">Adaptive Intelligence uses real-time emotion recognition to tailor educational content to how you feel at any given moment.</p>
            <p className="text-lg">By integrating advanced AI technologies like emotion analysis from Hume AI, we create a learning environment that responds uniquely to each student.</p>
          </div>
        </section>
